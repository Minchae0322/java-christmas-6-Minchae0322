...
import static christmas.validate.Validator.validateOrderedMenus;
...
public class InputView {
    ...
    public Map<Menu, Integer> readMenus(Restaurant restaurant) {
        ...
        String input = Console.readLine();
        try {
            Map<Menu, Integer> orderedMenus = Parser.parseMenu(restaurant, input);
            validateOrderedMenus(orderedMenus);
            return orderedMenus;
        } catch (IllegalArgumentException e) {
            System.out.println(e.getMessage());
